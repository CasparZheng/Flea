...
public struct FleaPalette {
    public static let Black     = UIColor(hex: 0x000000).withAlphaComponent(0.7)  //UIColor(hex: 0x1B242E)
    public static let DarkGray  = UIColor(hex: 0x606B78)
    public static let LightGray = UIColor(hex: 0x000000).withAlphaComponent(0.45) //UIColor(hex: 0xB3B7C1)
